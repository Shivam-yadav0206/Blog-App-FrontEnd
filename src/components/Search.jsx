...
const Search = ({ setFilteredPosts, posts }) => {
  const [searchText, setSearchText] = useState("");
  const handleSearch = () => {
    setFilteredPosts(posts.filter((post) => post.title.includes(searchText)));
    setSearchText("");
  };
  return (
    <div className="p-2 m-2">
      <div className="w-full mx-auto rounded-xl bg-white shadow-lg p-10 text-gray-800 relative overflow-hidden ">
